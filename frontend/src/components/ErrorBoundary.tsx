            ...
            return (
                ...
                >
                    ...
                    >
                        ...
                        <h1 className="text-2xl font-bold text-center mb-3" style={{ color: 'var(--text-main)' }}>
                        ...
                        {import.meta.env.DEV && this.state.error && (
                            ...
                            >
                                <div className="font-bold mb-2" style={{ color: 'var(--accent-red)' }}>
                                    Error Details:
                                </div>
                                ...
                                {this.state.errorInfo && (
                                    <details className="mt-4">
                                        ...
                                        <pre className="mt-2 text-xs" style={{ color: 'var(--text-soft)' }}>
                        ...
                        <div className="flex gap-3 justify-center">
                            <button
                                ...
                                style={{ backgroundColor: 'var(--accent-blue)', color: '#000000' }}
                            >
                                Reload Page
                            </button>
