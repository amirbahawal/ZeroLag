        ...
        >
            ...
            <div className="flex justify-between items-center mb-2 relative z-10">
                ...
                <div className="flex items-center gap-1.5">
                    <span className="text-[13px] font-semibold text-[color:var(--text-main)] tracking-tight">{symbol}</span>
                    <span className="text-[9px] bg-[color:var(--accent-blue)] text-white px-1 py-0.5 rounded-[3px] font-bold leading-none">F</span>
                </div>
